...
public class RelatoriosService {
	...
	private void bucaFuncionarioNome(Scanner scanner) {
	...
	private void pesquisaFuncionarioSalario() {
		...
		list.forEach(funcionario -> System.out.println("Funcionario: id: " + funcionario.getId()
